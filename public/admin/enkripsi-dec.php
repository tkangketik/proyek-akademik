                        ...
                        <div class="row">
                            <div class="col-md-5" style="padding: 10px; color: white;">
                                ...
                                <form action="" method="post" style="padding: 0px; margin: 0 auto;">
                                    <input class="form-control smooth text-center" placeholder="Kunci" name="kunci2" type="text" value="<?php echo $_GET['kunci'];?>" style="width: 100%; height:50px; margin-bottom:15px;" />
                                    <textarea class="form-control smooth text-center" rows="3" name="pesan2" id="pesan" placeholder="Ketikan pesan.."><?php echo $_GET['msg'];?></textarea>
